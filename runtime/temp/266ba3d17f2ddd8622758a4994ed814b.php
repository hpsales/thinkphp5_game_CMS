                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        <tr>
                            ...
                            <th><?php echo \think\Lang::get('amount'); ?><?php echo table_sort('amount'); ?></th>
                            <th><?php echo \think\Lang::get('userid'); ?></th>
                            <th><?php echo \think\Lang::get('order_sn'); ?></th>
                            <th><?php echo \think\Lang::get('paytype'); ?></th>
                            <th><?php echo \think\Lang::get('paystate'); ?></th>
                            <th><?php echo \think\Lang::get('state_order'); ?></th>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:middle"><?php echo $vo['amount']; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo->RechargeOrderSysUser->nick_name; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['order_sn']; ?></td>
                            <td style="vertical-align:middle"><?php echo config('pay_type')[$vo['paytype']]; ?></td>
                            <td style="vertical-align:middle"><?php echo config('paystate')[$vo['paystate']]; ?></td>
                            <td style="vertical-align:middle">
                                <?php if($vo['state_order'] == 1): ?><span style="color:green"><?php echo config('state_order')[$vo['state_order']]; ?></span><?php elseif($vo['state_order'] == 2): ?><?php echo config('state_order')[$vo['state_order']]; elseif($vo['state_order'] == 3): ?><span style="color:red"><?php echo config('state_order')[$vo['state_order']]; ?></span><?php endif; ?>
                            </td>

                            <td style="vertical-align:middle"><?php echo $vo['c_time']; ?></td>
                            <td> <a href="/admin/OrderLstDetail/lst?order_lst=<?php echo $vo['order_sn']; ?>" class="btn btn-xs btn-primary"><i class="fa fa-cart-plus"></i>分利明细</a> <?php echo authAction(CONTROLLER_NAME.'/edit', 'edit', ['id' => $vo['id']]); ?> <?php echo authAction(CONTROLLER_NAME.'/delete', 'delete', $vo['id']); ?> </td>
                            <?php $allmoney += $vo['amount'];endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                </div>
                <div class="box-footer clearfix">
                    总付款合计：<span style="color:red"><?php echo $allmoney2; ?></span> &nbsp&nbsp当页付款合计：<span style="color:red"><?php echo $allmoney; ?></span>
