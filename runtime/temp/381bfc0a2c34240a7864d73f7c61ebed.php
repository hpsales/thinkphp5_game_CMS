                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        <tr>
                            ...
                            <th><?php echo \think\Lang::get('rebate'); ?></th>
                            <th><?php echo \think\Lang::get('counts'); ?></th>
                            <th><?php echo \think\Lang::get('re_time'); ?></th>
                            <th><?php echo \think\Lang::get('to_id'); ?></th>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:middle"><?php echo $vo->UserRebateSysUser->nick_name; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['rebate']; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['counts']; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['re_time']; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo->UserRebateSysUser2->nick_name; ?></td>
                            <td><?php echo authAction(CONTROLLER_NAME.'/delete', 'delete', $vo['id']); ?> </td>
                            <?php $allmoney += $vo['counts'];endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                </div>
