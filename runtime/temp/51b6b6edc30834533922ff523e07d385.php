            ...
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover">
                        <tr>
                            <th><?php echo \think\Lang::get('bk_id'); ?></th>
                            <th><?php echo \think\Lang::get('bk_name'); ?></th>
                            <th><?php echo \think\Lang::get('bk_time'); ?></th>
                            <th><?php echo \think\Lang::get('bk_size'); ?></th>
                            <th width="250"><?php echo \think\Lang::get('action'); ?></th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo authAction(CONTROLLER_NAME.'/dowonload', 'dowonload', ['table' => $vo['name']]); ?> 
                                <?php echo authAction(CONTROLLER_NAME.'/restore', 'restore', $vo['name']); ?> 
                                <?php echo authAction(CONTROLLER_NAME.'/delete', 'delete', $vo['name']); ?> 
                            </td>
                        </tr>
