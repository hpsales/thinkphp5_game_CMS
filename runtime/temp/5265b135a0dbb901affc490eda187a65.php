                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        <tr>
                            ...
                            <th><?php echo \think\Lang::get('k'); ?></th>
                            <th><?php echo \think\Lang::get('v'); ?></th>
                            <th><?php echo \think\Lang::get('desc'); ?></th>
                            <th><?php echo \think\Lang::get('type'); ?><?php echo table_sort('type'); ?></th>
                            <th><?php echo \think\Lang::get('texttype'); ?><?php echo table_sort('texttype'); ?></th>
                            <th><?php echo \think\Lang::get('sorts'); ?><?php echo table_sort('sorts'); ?></th>
                            <th><?php echo \think\Lang::get('status'); ?><?php echo table_sort('status'); ?></th>
                            <th width="180"><?php echo \think\Lang::get('action'); ?></th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="k" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['k']; ?></span></td>
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="v" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['v']; ?></span></td>
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="desc" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['desc']; ?></span></td>
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="type" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['type']; ?></span></td>
                            <td><?php echo $vo['texttype']; ?></td>
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="sorts" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['sorts']; ?></span></td>
                            <td>
