                ...
                <div class="box-body table-responsive">
                     <table class="table table-bordered table-hover table-sort">
                        <tr>
                            ...
                            <th><?php echo \think\Lang::get('log_type'); ?></th>
                            <th><?php echo \think\Lang::get('ip'); ?></th>
                            <th><?php echo \think\Lang::get('log_detail'); ?></th>
                            <th><?php echo \think\Lang::get('admin_id'); ?></th>
                            <th><?php echo \think\Lang::get('add_time'); ?><?php echo table_sort('add_time'); ?></th>
                            <th width="124"><?php echo \think\Lang::get('action'); ?></th>
                        </tr>
