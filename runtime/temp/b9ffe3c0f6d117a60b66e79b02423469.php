                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        <tr>
                            ...
                            <th><?php echo \think\Lang::get('role_name'); ?><?php echo table_sort('role_name'); ?></th>                            
                            <th><?php echo \think\Lang::get('role_type'); ?></th>
                            <th><?php echo \think\Lang::get('role_pri'); ?></th>
                            <th><?php echo \think\Lang::get('describe'); ?></th>
                            <th><?php echo \think\Lang::get('add_time'); ?></th>
                            <th width="202"><?php echo \think\Lang::get('action'); ?></th>
                        </tr>
                        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td><input type="checkbox" name="id[]" value="<?php echo $vo['id']; ?>" class="minimal"></td>
                            <td><?php echo $vo['id']; ?></td>
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="role_name" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['role_name']; ?></span></td>                                                       
                            <td><?php echo $vo['role_type']; ?></td>
                            <td><?php echo $vo['role_pri']; ?></td>
                            <td><span class="editable" data-pk="<?php echo $vo['id']; ?>" data-name="describe" data-url="<?php echo url(CONTROLLER_NAME.'/edit', 'id='.$vo['id']); ?>" ><?php echo $vo['describe']; ?></span></td>
