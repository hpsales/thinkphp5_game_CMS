                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        <tr>
                            ...
                            <th>操作人</th>
                            <th>充值用户</th>
                            <th>充值数量/金额<?php echo table_sort('user_coins'); ?></th>
                            <th>充值类型</th>
                            <th>增加时间</th>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:middle"><?php echo $vo->RechargeFlowSysUser->nick_name; ?></td>
                   
                            <td style="vertical-align:middle"><?php echo $vo->RechargeFlowSysUser2->nick_name; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['user_coins']; ?>/<?php echo $vo['user_coins']/2; ?></td>
                            <td style="vertical-align:middle"><?php echo config('flag_1')[$vo['flag']]; ?></td>
