                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:middle"><?php echo $vo->RechargeCardsSysUser->nick_name; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo->RechargeCardsSysUser->user_name; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['counts']; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['recharge_id']; ?></td>
               
                         
                            <td style="vertical-align:middle"><?php echo $vo['recharge_time']; ?></td>
